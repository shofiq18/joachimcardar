  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-teal-700 via-teal-600 to-teal-500 text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-teal-100 mb-6 max-w-2xl mx-auto">
            For no time wise pregnant until for itself porta justo congue pitre pretium ligula
          </p>
      ...
      <div className="max-w-7xl mx-auto  py-16">
        <div className="">
          <h2 className="text-4xl font-bold text-gray-900 mb-12">Who We Are?</h2>
          
          <div className="grid md:grid-cols-2 relative gap-12 mb-12">
            {/* Left Column - Text */}
            <div>
              <p className="text-gray-600 leading-relaxed mb-6">
                We are idea generators, goal seekers, challenge-thirsty professionals, creators, entrepreneurs, thought leaders and unconventional solutions. Combining the most advanced web technologies, modern design and bold communication. For us, each project is a meaningful adventure, in which we become partners with our clients, on the road to perfection.
              </p>
            ...
            <div className="relative">
              ...
              {/* Checkmarks */}
              <div className="space-y-3 mb-6 mt-16">
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-teal-600" />
                  <span className="text-gray-700">far far away, behind the word mountains</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-teal-600" />
                ...
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-teal-600" />
                  <span className="text-gray-700">far from the countries Vokalia and Consonantia</span>
                </div>
              </div>
            </div>
            {/* Stats Card */}
              <div className="bg-white rounded-lg absolute bottom-20 left-64 right-0 shadow-xl p-8 grid grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 font-medium">Cars Sold</div>
                </div>
                <div className="text-center border-x border-gray-200">
                  <div className="text-4xl font-bold text-teal-600 mb-2">45,000+</div>
                  <div className="text-sm text-gray-600 font-medium">Satisfied Customers</div>
                </div>
                <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto ">
          ...
          <div className=" grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">List Your Car</h3>
              <p className="text-gray-600 leading-relaxed">
                Easily create a detailed listing with photos and information about your car
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Connect with Buyers</h3>
              <p className="text-gray-600 leading-relaxed">
                Receive offers and communicate directly with interested buyers through our secure platform
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Complete the Sale</h3>
              <p className="text-gray-600 leading-relaxed">
                Finalize the transaction with our support, ensuring a smooth and secure transfer of ownership
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Ready to Sell Your Car?</h2>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Get started today and experience the AutoMart difference.
          </p>
          <button className="bg-teal-600 text-white px-8 py-3 rounded-md hover:bg-teal-700 transition font-medium">
            Sell Your Car
          </button>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              <h2 className="text-4xl font-bold mb-4">
                ...
                M-A-W mobile Auto<br />
                welt Mobile App
              </h2>
              <p className="text-teal-100 mb-8 max-w-md">
                M-A-W mobile Auto welt companies work to sense more security and peace they have insurance coverage
              </p>
