...
//     console.log('Form submitted:', { businessType, name, phone, email, password });
...
//               {/* Form/Document */}
//               <rect x="80" y="140" width="150" height="190" rx="10" fill="white" stroke="#D1D5DB" strokeWidth="3" />

//               {/* Form fields */}
//               <rect x="100" y="165" width="50" height="8" rx="4" fill="#E5E7EB" />
//               <rect x="160" y="165" width="50" height="8" rx="4" fill="#E5E7EB" />

//               <rect x="100" y="190" width="110" height="8" rx="4" fill="#E5E7EB" />
//               <rect x="100" y="203" width="90" height="8" rx="4" fill="#E5E7EB" />

//               <rect x="100" y="228" width="110" height="8" rx="4" fill="#E5E7EB" />
//               <rect x="100" y="241" width="70" height="8" rx="4" fill="#E5E7EB" />

//               <rect x="100" y="266" width="110" height="8" rx="4" fill="#E5E7EB" />
//               <rect x="100" y="279" width="85" height="8" rx="4" fill="#E5E7EB" />

//               {/* Create button */}
//               <rect x="100" y="300" width="110" height="18" rx="6" fill="#0F766E" />
//               <text x="155" y="312" fontSize="10" fill="white" textAnchor="middle" fontWeight="bold">CREATE</text>

//               {/* Plus icon */}
//               <circle cx="240" cy="100" r="26" fill="#0F766E" />
//               <path d="M240 85 L240 115 M225 100 L255 100" stroke="white" strokeWidth="5" strokeLinecap="round" />

//               {/* Person illustration */}
//               {/* Head */}
//               <circle cx="120" cy="75" r="25" fill="#F3E8E0" />

//               {/* Hair */}
//               <path d="M100 65 Q95 50 105 45 L120 43 Q130 45 135 50 Q145 60 140 70 L120 75" fill="#1F2937" />
//               <path d="M98 68 Q93 70 95 75 L100 78" fill="#1F2937" />
//               <path d="M142 68 Q147 70 145 75 L140 78" fill="#1F2937" />

//               {/* Eyes */}
//               <circle cx="113" cy="73" r="2" fill="#1F2937" />
//               <circle cx="127" cy="73" r="2" fill="#1F2937" />

//               {/* Smile */}
//               <path d="M112 83 Q120 87 128 83" stroke="#1F2937" strokeWidth="2" strokeLinecap="round" fill="none" />

//               {/* Body - Shirt */}
//               <ellipse cx="120" cy="130" rx="40" ry="42" fill="#475569" />

//               {/* Neck */}
//               <rect x="110" y="98" width="20" height="18" fill="#F3E8E0" />

//               {/* Arms */}
//               <path d="M85 125 Q80 130 85 145 L90 165" stroke="#F3E8E0" strokeWidth="12" strokeLinecap="round" />
//               <path d="M155 125 Q160 135 158 145" stroke="#F3E8E0" strokeWidth="12" strokeLinecap="round" />

//               {/* Right hand pointing */}
//               <circle cx="90" cy="165" r="9" fill="#F3E8E0" />
//               <path d="M90 165 L88 155 L86 148" stroke="#F3E8E0" strokeWidth="7" strokeLinecap="round" />

//               {/* Left hand on hip */}
//               <circle cx="158" cy="145" r="9" fill="#F3E8E0" />

//               {/* Legs */}
//               <path d="M100 170 L95 230" stroke="#1F2937" strokeWidth="16" strokeLinecap="round" />
//               <path d="M140 170 L145 230" stroke="#1F2937" strokeWidth="16" strokeLinecap="round" />

//               {/* Shoes */}
//               <ellipse cx="95" cy="235" rx="16" ry="7" fill="#1F2937" />
//               <ellipse cx="145" cy="235" rx="16" ry="7" fill="#1F2937" />

//               {/* Plant decoration */}
//               <ellipse cx="55" cy="280" rx="18" ry="25" fill="#10B981" />
//               <path d="M40 265 Q33 252 40 245" fill="#059669" />
//               <path d="M70 270 Q78 260 75 250" fill="#059669" />
//               <ellipse cx="75" cy="295" rx="12" ry="18" fill="#14B8A6" />
//             </svg>
//           </div>

//           <p className="text-gray-600 mt-8">
//             Don&#39;t have an account?{' '}
//             <a href="/sign-in" className="text-teal-700 font-semibold hover:text-teal-800">
//               Login
//             </a>
//           </p>
//         </div>
