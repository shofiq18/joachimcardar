    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className=" mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#636F85] text-base mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg md:p-6 2xl:p-10 shadow-sm border border-gray-200">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[#636F85] text-base">Total Sent</p>
                <p className="text-xl font-semibold text-[#2D2D2D] mt-4">248 Notification</p>
              </div>
          ...
          <div className="bg-white rounded-lg md:p-6 2xl:p-10 shadow-sm border border-gray-200">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[#636F85] text-base">This Month</p>
                <p className="text-xl font-semibold text-[#2D2D2D] mt-4">32 Notification</p>

              </div>
              <div className="">
                <Image
                  src="/notifcation-month.svg"
                  alt="Listings"
                  width={48}
                  height={48}
                />
          ...
          <div className="bg-white rounded-lg md:p-6 2xl:p-10 shadow-sm border border-gray-200">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[#636F85] text-base">Avg. Open Rate</p>
                <p className="text-xl font-semibold text-[#2D2D2D] mt-2">68.5%</p>
              </div>
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200 mb-8">
          ...
          <Button
            ...
            className="w-full bg-[#00695C] hover:bg-teal-700 text-white py-6 rounded-lg font-medium flex items-center justify-center gap-2"
          >
              ...
              <tbody>
                {mockNotifications.map((notification) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm">
                      <span
                        className={`px-4 py-2 rounded-sm text-xs font-medium ${
                          typeColors[notification.type].badge
                        }`}
                      >
                        {notification.type}
                      </span>
                    ...
                    <td className="px-6 py-4 text-sm">
                      <span className="px-4 py-2 rounded-sm text-xs font-medium bg-green-100 text-green-700">
                        {notification.status}
                      </span>
                    </td>
                  </tr>
